...
const StyledTableRow = withStyles((theme) => ({
  root: {
    '&:nth-of-type(odd)': { //Gray Color background for rows
...
//Table row Content
const rows = [
  createData(<Icon1 src={HeaderAdIcon} alt='' />, 'Header Advantage', 'adv_gold.svg', 'X', '#f5b100', '32px'),
  createData(<Icon1 src={AdBadgeIcon} alt=''/>, 'Advantage Badge', 'adv-badge-sm.png', 'X', '', '32px'),
  createData(<Icon1 src={HeaderPlatIcon} alt=''/>, 'Header Platinum', 'plat-bug-gold.svg', 'x', '#f5b100', '32px'),
  createData(<Icon1 src={HeaderGPIcon} alt=''/>, 'Header Advantage', 'gp-bug-gold.svg', 'x', '#f5b100', '32px'),
  createData(<Icon1 src={HNPIcon} alt=''/>, 'Header Northern Preferred', '', 'x', '#f5b100', ''),
  createData(<Icon1 src={HeaderCartIcon} alt=''/>,'Header Cart', 'cart_gold.svg', 'x', '#f5b100', '40px'),
  createData(<Icon1 src={HSBarcodeIcon} alt=''/>, 'Header Search Barcode', 'upc.svg', 'x', '#505050', ''),
  createData(<Icon1 src={FFacebookIcon} alt=''/>, 'Footer Facebook', 'Facebook_circle_pictogram.svg', 'x', '#505050', '32px'),
  createData(<Icon1 src={FTwitterIcon} alt=''/>, 'Footer Twitter', 'twitter.svg', 'x', '#505050', '32px'),
  createData(<Icon1 src={FYoutubeIcon} alt=''/>, 'Footer YouTube', 'YouTube_social_dark_circle.svg', 'x', '#505050', '32px'),
  createData(<Icon1 src={FPinterestIcon} alt=''/>, 'Footer Pinterest', 'pinterest-round.svg', 'x', '#505050', '32px'),
  createData(<Icon1 src={FInstagramIcon} alt=''/>, 'Footer Instagram', 'instagram-circle.svg', 'x', '#505050', '32px'),
  createData(<Icon2 src={FulStoresIcon} alt=''/>, 'Fulfillment Stores', 'icon-store-black.svg', 'x', '', '72px'),
  createData(<Icon3 src={FulBOPISIcon} alt=''/>, 'Fulfillment BOPIS', 'delivery-icon-store-pickup.svg', 'x', '', '72px'),
  createData(<Icon2 src={FulCurbsideIcon} alt=''/>, 'Fulfillment Curbside', 'curbside-pickup.svg', 'x', '', '72px'),
  createData(<Icon2 src={FulShipToStoreIcon} alt=''/>, 'Fulfillment Ship to Store', 'ship-to-store.svg', 'x', '', '72px'),
  createData(<Icon2 src={FulSDDeliveryIcon} alt=''/>, 'Fulfillment Same Day Delivery', 'same-day-delivery.svg', 'x', '', '72px'),
  createData(<Icon2 src={FulDeliveryIcon} alt=''/>, 'Fulfillment Delivery', 'shipping.svg', 'x', '', '72px'),
